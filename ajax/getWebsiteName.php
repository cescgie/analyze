...
$query="SELECT WebsiteId, adtech_webseiten.name WebsiteName,count(*) FROM yoggi.uid_webid_test,absolutebusy.adtech_webseiten Where adtech_webseiten.id = uid_webid_test.WebsiteId GROUP BY WebsiteId HAVING count(*) >=1 ORDER BY WebsiteId DESC";
